...
QT_MOC_LITERAL(4, 31, 5), // "words"
QT_MOC_LITERAL(5, 37, 13), // "backRequested"
QT_MOC_LITERAL(6, 51, 7) // "restart"

    },
    "GameWidget\0gameFinished\0\0score\0words\0"
    "backRequested\0restart"
};
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gameFinished((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QStringList(*)>(_a[2]))); break;
        ...
        {
            using _t = void (GameWidget::*)(int , const QStringList & );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWidget::backRequested)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameWidget::gameFinished(int _t1, const QStringList & _t2)
{
