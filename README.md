...
> 安阳（故乡）× 软件学院 × 国庆七十七华诞 —— 一个可以「点、拖、玩」的 Qt 桌面交互程序。
...
| 环节 | 交互 | 表达 |
| --- | --- | --- |
| 主场景 | 软件学院**实拍夜景**铺满全屏，窗户亮着，桌上有月饼和电脑 | 留校的日常被看见 |
...
| 点亮全楼 | 进入**接月饼小游戏**：接住写有六个词的月饼，每接住一个点亮一扇窗户 | 每个人都为全楼添一盏灯 |
